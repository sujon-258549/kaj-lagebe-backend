...
const getOverview = async (
  ...
  // Worker / Admin: applicant-side stats
  if (isWorker || isAdmin) {
    const [
      myApplicationsCount,
      pendingApplications,
  ...
  // Blog stats (everyone — they may post blogs)
  const [
    myBlogsCount,
  ...
  // Charts: last 14 days timeseries (role-aware)
  ...
  // Top jobs by applicants (User/Admin)
  if (isUser || isAdmin) {
