...
const getAllFolders = catchAsync(async (req: Request, res: Response) => {
  ...
  const result = await FolderServices.getAllFolders(query);
  sendResponse(res, {
    success: true,
...
const getFolderById = catchAsync(async (req: Request, res: Response) => {
  const result = await FolderServices.getFolderById(req.params.id as string);
  sendResponse(res, {
    success: true,
    statusCode: httpStatus.OK,
...
const deleteFolder = catchAsync(async (req: Request, res: Response) => {
  const result = await FolderServices.deleteFolder(req.params.id as string);
  sendResponse(res, {
    success: true,
    statusCode: httpStatus.OK,
